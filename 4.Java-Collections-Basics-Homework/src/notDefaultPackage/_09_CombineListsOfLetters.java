...
but only when c does not appear in l1. Print the obtained combined list. All lists are given as sequence of letters separated by 
a single space, each at a separate line. Use ArrayList<Character> of chars to keep the input and output lists. */
...
public class _09_CombineListsOfLetters {
	...
	private static ArrayList<Character> readListChar() {
